        ...
        <div id='about-us' className="">
            <div className="max-w-6xl py-5 mx-auto">
                ...
                <div className="">
                    ...
                    <p className='py-2'>
                        As a client-centered agency, we focus on understanding your unique challenges and goals, ensuring our solutions are aligned with your vision. Whether you're looking to streamline processes, improve customer experience, or scale your business with the latest technology, Tech Bite Solution is here to guide you every step of the way.
